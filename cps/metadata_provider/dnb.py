...
"""
Autocaliweb Metadata Provider for Deutsche Nationalbibliothek (DNB).
                            BETA VERSION
This module provides metadata fetching capabilities for Autocaliweb
by adapting the original Calibre DNB metadata source plugin.

This file is part of the Autocaliweb project.

Based on:
    Calibre Metadata Source Plugin for Deutsche Nationalbibliothek (DNB)
    Original Copyright (C) 2017, Bernhard Geier <geierb@geierb.de>
