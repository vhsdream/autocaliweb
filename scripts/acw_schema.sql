CREATE TABLE IF NOT EXISTS acw_enforcement(
...
CREATE TABLE IF NOT EXISTS acw_import(
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    timestamp TEXT NOT NULL,
    filename TEXT NOT NULL,
    original_backed_up TEXT NOT NULL
);
CREATE TABLE IF NOT EXISTS acw_conversions(
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    timestamp TEXT NOT NULL,
    filename TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS acw_settings(
    ...
    acw_update_notifications SMALLINT DEFAULT 1 NOT NULL,
